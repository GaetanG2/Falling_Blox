...
public class TTetromino extends Tetromino {
	...
	protected void setElements(Coordonnees coordonnees, Couleur couleur) {
		...
		this.getElements()[2] = new Element(coordonnees.getAbscisse()-1, coordonnees.getOrdonnee(), couleur);
		this.getElements()[3] = new Element(coordonnees.getAbscisse(), coordonnees.getOrdonnee()+1, couleur);
	}
