...
class TTetrominoTest {


	// test du constructeur de TTetromino
	@Test
	public void testConstructeur() {
		Coordonnees cord = new Coordonnees(4, 5);
		TTetromino tetro = new TTetromino(cord, Couleur.BLEU);
		...
		assertEquals(new Element(cord.getAbscisse()-1, cord.getOrdonnee() , Couleur.BLEU), elemt[2]);
		assertEquals(new Element(cord.getAbscisse() , cord.getOrdonnee()+1, Couleur.BLEU), elemt[3]);
	...
	public void testSetter() {
		...
		TTetromino tetro = new TTetromino(new Coordonnees(0, 0), Couleur.BLEU);
		...
		assertEquals(new Element(cord.getAbscisse()-1, cord.getOrdonnee() , Couleur.CYAN), elemt[2]);
		assertEquals(new Element(cord.getAbscisse() , cord.getOrdonnee()+1, Couleur.CYAN), elemt[3]);
	...
	public void testSetPosi() {
		...
		assertEquals(new Element(5, 6, Couleur.BLEU), elemt[2]);
		assertEquals(new Element(6, 7, Couleur.BLEU), elemt[3]);
	...
	public void testTourner() throws BloxException {
		TTetromino tetro = new TTetromino(new Coordonnees(3, 3), Couleur.ROUGE);
		TTetromino tetro1 = new TTetromino(new Coordonnees(3, 3), Couleur.BLEU);
		...
		assertEquals(new Element(new Coordonnees(3, 2), Couleur.ROUGE), elemt[2]);
		assertEquals(new Element(new Coordonnees(2, 3), Couleur.ROUGE), elemt[3]);
		...
		assertEquals(new Element(new Coordonnees(3, 4), Couleur.BLEU), elemt1[2]);
		assertEquals(new Element(new Coordonnees(4, 3), Couleur.BLEU), elemt1[3]);
	}

	@Test
	// test de la representation textuelle
	public void testToString() {
		TTetromino tetro = new TTetromino(new Coordonnees(3, 5), Couleur.BLEU);

		// assertEquals(null,tetro.getElements());
		assertEquals("TTetromino :\n" + "	" + "(3, 5) - BLEU" + "\n" + "	" + "(4, 5) - BLEU" + "\n" + "	"
				+ "(2, 5) - BLEU" + "\n" + "	" + "(3, 6) - BLEU" + "\n", tetro.toString());
	}
	...
	public void deplacerDeHori() throws BloxException {
		STetromino tetro = new STetromino(new Coordonnees(5, 5), Couleur.ROUGE);
